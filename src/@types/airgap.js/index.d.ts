...
export type ConsentManagerConfig = Partial<{
  ...
  dialog_header_text: string;
  /** Consent manager dialog body text */
  dialog_body_text: string;
  dialog_more_body_text: string;
  RequiredByLaw: string;
  Parkinsons_Cursor_Tracking: string;
  prefsHeader: string;
  /** Consent manager required disclosures header text */
  requiredDisclosuresHeader: string;
  GovernmentRequiredDataCollection: string;
